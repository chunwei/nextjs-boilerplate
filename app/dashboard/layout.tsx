  ...
  children: React.ReactNode
    ...
    useEffect(() => {
      if (status === 'authenticated' && session?.user) {
        ...
        if (teamFromParams && session.user.teams?.some(team => team.url === teamFromParams)) {
          setInitialTeam(teamFromParams)
          setInitialBotId(typeof params.botId === 'string' ? params.botId : undefined)
          return
        }
    ...
    if (status === 'loading' || (!initialTeam && pathname !== '/dashboard/teams/join')) {
